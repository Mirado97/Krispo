...
export const CONFIG = {
  ...
  SIGNATURE_TYPE: envInt('SIGNATURE_TYPE', 0), // 0=EOA, 1=POLY_PROXY, 2=GNOSIS_SAFE, 3=POLY_1271
  ...
  // Exchange contracts (V2, deployed 2026-04-28)
  ...
  PUSD_ADDRESS: '0xC011a7E12a19f7B1f670d46F03B03f3342E82DFB', // Polymarket USD (V2 collateral, wraps USDC)
